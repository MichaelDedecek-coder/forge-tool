...
export default function Home() {
  ...
  const [isDemoMode, setIsDemoMode] = useState(false); // New Flag for Demo
  ...
  const styles = `
    ...
    .cta-button { display: inline-flex; align-items: center; gap: 12px; background: linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%); color: white; padding: 18px 36px; border-radius: 12px; font-size: 18px; font-weight: 700; text-decoration: none; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 20px rgba(6, 182, 212, 0.4); cursor: pointer; border: none; }
    .cta-button:hover { transform: translateY(-2px); box-shadow: 0 6px 30px rgba(6, 182, 212, 0.5); }
    ...
    .step:hover { transform: translateY(-4px); border-color: rgba(6, 182, 212, 0.3); }
    ...
    .cta-section { text-align: center; padding: 60px 40px; background: rgba(6, 182, 212, 0.05); border-radius: 24px; border: 1px solid rgba(6, 182, 212, 0.2); margin-bottom: 60px; }
    ...
    .enter-here-btn { background: none; border: none; color: #06b6d4; cursor: pointer; font-weight: 600; text-decoration: underline; font-size: 14px; padding: 0 5px; }
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", backgroundColor: "#030712", color: "white", fontFamily: "sans-serif" }}>
                ...
                <div style={{ padding: "40px", background: "rgba(255,255,255,0.05)", borderRadius: "12px", border: "1px solid #333", textAlign: "center", maxWidth: "400px", width: "90%" }}>
                    ...
                    <div style={{ marginTop: "20px", borderTop: "1px solid #333", paddingTop: "20px" }}>
                       <button onClick={handleStartDemo} style={{ background: "none", border: "none", color: "#06b6d4", cursor: "pointer", fontSize: "14px", fontWeight: "bold" }}>{txt.cta_demo}</button>
                    </div>
                </div>
            </div>
        );
    ...
    <div className="landing-container">
        ...
        <main>
            ...
            <section ref={accessSectionRef} className="cta-section">
                ...
                <p className="pin-note">{txt.pin_note}</p>
