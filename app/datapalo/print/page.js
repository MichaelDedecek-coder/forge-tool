  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (!dataReceived) {
        ...
        const storedData = localStorage.getItem("datapalo_print_data");
        const storedLang = localStorage.getItem("datapalo_print_language");
      ...
      <style jsx global>{`
        ...
        @media print {
          ...
          * {
          ...
          @page {
            @bottom-center {
              content: "Generated by DataPalo AI | forgecreative.cz/datapalo | Page " counter(page) " of " counter(pages);
              font-size: 8pt;
              color: #94a3b8;
            }
          }
      ...
      <div className="print-header no-print">
        <div>
          <h2 style={{ margin: 0, fontSize: "18px" }}>
            <span style={{ color: "#0ea5e9" }}>Data</span>Palo Print Preview
          </h2>
